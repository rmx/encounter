...
export function
objectivesCompleted(party: Party): boolean {
...
export function
numCompletedObjectives(party: Party): number {
...
export class Aura {
    ...
    static parseJSON(json): Aura {
        return new Aura
            ...
            , J.string(json, 'slot')
            , J.string(json, 'auraId')
            , J.number(json, 'createdAt')
            , J.opt(json, 'energy',       J.number)
            , J.opt(json, 'stackCount',   J.number)
            , J.opt(json, 'duration',     J.number)
            , J.opt(json, 'tickInterval', J.number)
            );
    }
...
export class GroundAreaEffect {
    ...
    static parseJSON(json: any): GroundAreaEffect {
        return new GroundAreaEffect
            ...
            , J.number(json, 'duration')
            , J.number(json, 'radius')
            , J.string(json, 'auraId')
            );
    }
...
export class Spell {
    ...
    static parseJSON(json): Spell {
        return new Spell
            ...
            , J.number(json, 'startedAt')
            , J.number(json, 'castTime')
            , J.opt(json, 'pulseTime', J.number)
...
export class SpellCooldownEntry {
    ...
    static parseJSON(json) {
        var cooldownTimer = J.object(json, 'cooldownTimer');

        return new SpellCooldownEntry
            ( J.string(json, 'id')
            , J.number(cooldownTimer, 'start')
            , J.number(cooldownTimer, 'duration')
            );
    }
