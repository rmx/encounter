...
import { Vec3, vec3, Mat4, mat4 } from 'gl-matrix';
import { _ } from 'underscore';

import { EntityId } from './Ids';
import { HalfEdgeMesh, HalfEdgeEdge, HalfEdgeVertex, HalfEdgeFace } from './Navmesh';
...
export class Terrain {
    ...
    ,        tileMap   : { [id: string]: Storage.Tile }
...
export class TerrainTile {
    ...
    constructor
    ( public id      : string
    , public surface : Storage.Geometry
    , public size    : Vec3
    ) {
