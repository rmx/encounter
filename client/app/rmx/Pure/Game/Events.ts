...
module rmx.Pure.Game {
    ...
    export class CombatEvent {
        ...
        toJSON() {
            return { source   : variantToJSON(this.source, combatEventSourceTypes)
                   , entityId : this.entityId
                   , event    : variantToJSON(this.event, combatEventTypes)
                   };
        }

        static parseJSON(json): CombatEvent {
            return new CombatEvent
                ( variantFromJSON(json.source, combatEventSourceTypes)
                , JSON.string(json, 'entityId')
                , variantFromJSON(json.event, combatEventTypes)
                );
        }
    }
