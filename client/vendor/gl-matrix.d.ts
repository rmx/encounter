...
declare type Mat2 = Float32Array | number[];
...
declare type Mat2d = Float32Array | number[];
...
declare type Mat3 = Float32Array | number[];
...
declare type Mat4 = Float32Array | number[];
...
declare type Quat = Float32Array | number[];
...
declare type Vec2 = Float32Array | number[];
interface Vec2Static {
    ...
    forEach<T, ArrayType>(a: ArrayType, stride: number, offset: number, count: number, fn: (out: Vec2, a: Vec2, arg: T) => void, arg: T): ArrayType;
...
declare type Vec3 = Float32Array | number[];
interface Vec3Static {
    ...
    forEach<T, ArrayType>(a: ArrayType, stride: number, offset: number, count: number, fn: (out: Vec3, a: Vec3, arg: T) => void, arg: T): ArrayType;
...
declare type Vec4 = Float32Array | number[];
interface Vec4Static {
    ...
    forEach<T, ArrayType>(a: ArrayType, stride: number, offset: number, count: number, fn: (out: Vec4, a: Vec4, arg: T) => void, arg: T): ArrayType;
